...
- [x] Commit and push the release changes to `main` (`746a032a67976d32bb95087127c549e9382a494c`).
- [x] Publish `v.1.5.9` from the exact `main` commit with the verified package asset.
...
- [x] Synchronize null-safety and macOS asset-catalog fixes.
- [x] Vendor the macOS packaging lifecycle from ROI.BuildActions 1.1.3.
...
- [x] Verify that the package contains only the sanitized sample configuration.
